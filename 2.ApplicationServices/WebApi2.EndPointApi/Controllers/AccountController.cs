...
using WebApi2.EndPointApi.Models;
using WebApi2.EndPointApi.Results;
...
namespace WebApi2.EndPointApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public AccountController(UserManager<IdentityUserViewModel, long> userManager, IClientService clientService)
        {
